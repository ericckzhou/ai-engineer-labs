"""chat_with_memory.py — [learner] The core of Project 05 (Personal Memory System). THIS is what you build.
...
Run:  python chat_with_memory.py
"""
...
def main() -> None:
    cfg = load_config()
    print(f"Project 05 (Personal Memory System) — model: {cfg.model}")
    # TODO(learner): build this project's core. See ../source/project.md and the lesson.
    raise NotImplementedError(
        "Project 05 core not implemented yet — this is your work to build."
    )
