"""tokenizer_explorer.py — [learner] The core of Project 02 (Token & Embedding Explorer). THIS is what you build.
...
def main() -> None:
    cfg = load_config()
    print(f"Project 02 (Token & Embedding Explorer) — model: {cfg.model}")
    # TODO(learner): build this project's core. See ../source/project.md and the lesson.
    raise NotImplementedError(
        "Project 02 core not implemented yet — this is your work to build."
    )
