"""search.py — [learner] The core of Project 03 (Semantic Search). THIS is what you build.
...
def main() -> None:
    cfg = load_config()
    print(f"Project 03 (Semantic Search) — model: {cfg.model}")
    # TODO(learner): build this project's core. See ../source/project.md and the lesson.
    raise NotImplementedError(
        "Project 03 core not implemented yet — this is your work to build."
    )
